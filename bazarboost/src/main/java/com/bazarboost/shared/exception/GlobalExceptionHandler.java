...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleProductoInvalido(ProductoInvalidoException ex) {
        System.out.println("ProductoInvalidoException: " + ex.getMessage());
        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).body(ex.getMessage());
    }

    @ExceptionHandler(FacturaNoEncontradaException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<String> handleFacturaNoEncontrada(FacturaNoEncontradaException ex) {
        System.out.println("FacturaNoEncontradaException: " + ex.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ex.getMessage());
    }

    @ExceptionHandler(AsignacionRolInvalidaException.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ResponseEntity<String> handleAsignacionRolInvalida(AsignacionRolInvalidaException ex) {
        System.out.println("AsignacionRolInvalidaException: " + ex.getMessage());
        return ResponseEntity.status(HttpStatus.CONFLICT).body(ex.getMessage());
    }

    @ExceptionHandler(TelefonoExistenteException.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ResponseEntity<String> handleTelefonoExistente(TelefonoExistenteException ex) {
        System.out.println("TelefonoExistenteException: " + ex.getMessage());
        return ResponseEntity.status(HttpStatus.CONFLICT).body(ex.getMessage());
    }

    @ExceptionHandler(ContraseniasNoCoincidentesException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<String> handleContraseniasNoCoincidentes(ContraseniasNoCoincidentesException ex) {
        System.out.println("ContraseniasNoCoincidentesException: " + ex.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ex.getMessage());
    }
